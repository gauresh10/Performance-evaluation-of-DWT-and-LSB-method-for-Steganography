...
cover_image=imread('landscape.jpg');
figure(1);
subplot(2,2,1);
...
%select LL band
img=c_LL;
% generate R G B Image
red1=img(:,:,1);
green1=img(:,:,2);
blue1=img(:,:,3);

% single value decomposition, generating "S" matrix having  values with U nd
% Vwith zero elements
...
secret_image=imread('fruits.jpg');
